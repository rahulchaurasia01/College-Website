<%@ Page Title="Defaulter" Language="C#" MasterPageFile="~/Login/Faculty/Faculty.master" AutoEventWireup="true" CodeFile="Defaulter.aspx.cs" Inherits="Login_Faculty_Defaultert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <div class="container">
            <div class="text-center">
                <asp:Label ID="Label1" runat="server" Text="Add Defaulter List" Font-Bold="True" Font-Size="Medium"></asp:Label>
            </div>
            <br />
            <div class="text-center">
            ...
            <div class="text-center" id="do">
                <asp:FileUpload ID="defaulterFileUpload1" runat="server" />
            </div>
            <br />
             <div class="row">
        ...
        <div class="col-xs-2">
            <asp:DropDownList ID="DefaulterDropDownList1" runat="server" ToolTip="Department" CssClass="form-control">
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            <asp:DropDownList ID="DefaulterDropDownList2" runat="server" ToolTip="Class" CssClass="form-control">
