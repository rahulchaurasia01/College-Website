<%@ Page Title="Question Bank" Language="C#" MasterPageFile="~/Login/Faculty/Faculty.master" AutoEventWireup="true" CodeFile="Questionbank.aspx.cs" Inherits="Login_Faculty_Questionbank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <div class="container">
            <div class="text-center">
                <asp:Label ID="Label1" runat="server" Text="Add Question Bank" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <br />
            <div class="text-center">
            ...
            <div class="text-center" id="do">
                <asp:FileUpload ID="questionbankFileUpload1" runat="server" />
            </div>
            <br />
             <div class="row">
        ...
        <div class="col-xs-2">
            <asp:DropDownList ID="questionbankDropDownList1" runat="server" ToolTip="Department" CssClass="form-control">
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            <asp:DropDownList ID="questionbankDropDownList2" runat="server" ToolTip="Class" CssClass="form-control">
