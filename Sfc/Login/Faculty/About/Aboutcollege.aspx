<%@ Page Title="" Language="C#" MasterPageFile="~/Login/Faculty/Faculty.master" AutoEventWireup="true" CodeFile="Aboutcollege.aspx.cs" Inherits="About_About" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="text-center"><font face="Georgia" size="22" color="Black">Saraswati College of Engineering</font></h1>


<br><br><br><br>
    
    <div class="container">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Saraswati College 2.jpg" ImageAlign="Left" Height="228px" Width="304px" />
...
<br/><br />
        ...
        <asp:Image ID="Image2" runat="server" ImageUrl="~/Saraswati College 3.jpg" ImageAlign="Right" Height="228px" Width="304px" />

<font face="Georgia" size="4" color="Black">

<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Saraswati Education society lays special emphasis on providing the best possible infrastructure for learning in all its campuses. 
