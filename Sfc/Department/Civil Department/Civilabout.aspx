<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Civilabout.aspx.cs" Inherits="Department_Civil_Department_Civilabout" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>About - Civil Department</title>
...
<p>  The department of civil engineering was established in the year 2004. It offers students sound technical know-how in better utilization of available resources and greater standardization of construction processes required by construction industry. </p>
<p>Students are trained how to make use of innovative design methods and techniques and their practical implementation. Exposure to contemporary planning, design, construction and project management are main objectives of the course. Highly qualified and dedicated staff members that are always on their toes to guide the students, form the backbone of the department. 
</p>
            </div>
        <div class="container-fluid">
        <hr />
