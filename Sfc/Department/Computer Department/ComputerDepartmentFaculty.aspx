<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComputerDepartmentFaculty.aspx.cs" Inherits="Department_Computer_Department_ComputerDepartmentFaculty" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Faculty - Computer Department</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <h1 class="text-center">Computer Department</h1><br /><br />
            <center>
            <asp:Table ID="Table1" runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>&nbsp;Dr. Bharati Joshi</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>2</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Arti K. Gore</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>3</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Deepa Parasar</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>4</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Madhuri Dalal</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>5</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Bhagyashri Sonawale</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>6</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Sujata T. Bhairnallykar&nbsp;&nbsp;</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>7</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mr.Dhanraj D. Walunj</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>8</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Monali V. Deshmukh</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>9</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Hemalata A.Gosavi</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>10</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Purtata K. Bhoir</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>11</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Rina K. Bora</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>12</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mr. Amit A.Gawade</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>13</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Vijayshree M. Shinde</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>14</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs.Suman S. Bhujbal</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>15</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Ramya R. B.</asp:TableCell>
                    <asp:TableCell>&nbsp;Adjucant Faculty</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>16</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Mrs. Rashmi P. Patel</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell><center>17</center></asp:TableCell>
                    <asp:TableCell>&nbsp;Ms. Amee Upadhyay</asp:TableCell>
                    <asp:TableCell>&nbsp;Full Time</asp:TableCell>
                </asp:TableRow>
            </asp:Table>
                </center>
